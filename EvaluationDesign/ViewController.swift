...
class ViewController: UIViewController {
    ...
    func setUI() {
        ...
        // Welcome Labels
        welcomeLabel.text = "Disfruta del turismo"
        welcomeLabel.textColor = UIColor(red: 45/255, green: 55/255, blue: 24/255, alpha: 1)
        ...
        welcomeLabel2.text = "de Nicaragua"
        ...
        NSLayoutConstraint.activate([
            welcomeLabel2.topAnchor.constraint(equalTo: welcomeLabel.bottomAnchor, constant: 10),
        ...
        signUpButton.backgroundColor = UIColor(red: 255/255, green: 179/255, blue: 71/255, alpha: 1)
        ...
        signInButton.setTitleColor(UIColor(red: 255/255, green: 179/255, blue: 71/255, alpha: 1), for: .normal)
    ...
    func createInputSection(title: String, placeholder: String, iconName: String, isSecure: Bool) -> UIView {
        ...
        underlineView.backgroundColor = UIColor(red: 255/255, green: 179/255, blue: 71/255, alpha: 1)
    ...
    func setSignInView() {
        ...
        signInButton2.setTitle("Sign in", for: .normal)
        signInButton2.translatesAutoresizingMaskIntoConstraints = false
        signInButton2.backgroundColor = UIColor(red: 255/255, green: 179/255, blue: 71/255, alpha: 1)
        signInButton2.setTitleColor(.white, for: .normal)
        ...
        let usernameSectionSignIn = createInputSection(title: "Username", placeholder: "", iconName: "person.fill", isSecure: false)
        let passwordSectionSignIn = createInputSection(title: "Password", placeholder: "", iconName: "key.fill", isSecure: true)
    ...
    func setSignUpView(){
        ...
        newAccountLabel1.text = "Create New"
